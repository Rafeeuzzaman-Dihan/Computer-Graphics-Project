...
string msg[6] = { "OPENGL PROJECT","TOPIC: RIVERSIDE SCENARIO ","       DURING DAY AND NIGHT","PRESS [S] TO START" };
string ins[6] = { "D: DAY","N: NIGHT","H: START HORSE","F: STOP","B: START BOAT","E: STOP" };
string t, lef = "WARM LAND BREEZE", rig = "COOL RIVER BREEZE";		//temp string, left label, right label
...
//movement of up arrow (i.e. river breeze)
void uArrow()
{
	uArrowY += .5;
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("River Breeze & Land Breeze");
